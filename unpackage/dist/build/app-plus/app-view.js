...
var oFC=_oz(z,67,t7B,a6B,gg)
_(hEC,oFC)
_(oBC,hEC)
_(o0B,oBC)
var cGC=_n('view')
_rz(z,cGC,'class',68,t7B,a6B,gg)
var oHC=_n('view')
...
_(cGC,eLC)
_(o0B,cGC)
var oNC=_mz(z,'view',['catchtap',75,'class',1,'data-event-opts',2],[],t7B,a6B,gg)
var xOC=_v()
_(oNC,xOC)
if(_oz(z,78,t7B,a6B,gg)){xOC.wxVkey=1
var fQC=_n('view')
_rz(z,fQC,'class',79,t7B,a6B,gg)
var cRC=_v()
_(fQC,cRC)
if(_oz(z,80,t7B,a6B,gg)){cRC.wxVkey=1
var hSC=_n('view')
var oTC=_n('text')
_(hSC,oTC)
_(cRC,hSC)
...
var cUC=_v()
_(cRC,cUC)
if(_oz(z,81,t7B,a6B,gg)){cUC.wxVkey=1
var oVC=_n('view')
var lWC=_n('text')
_(oVC,lWC)
var aXC=_n('text')
...
var tYC=_v()
_(cUC,tYC)
if(_oz(z,82,t7B,a6B,gg)){tYC.wxVkey=1
var eZC=_n('view')
var b1C=_n('text')
_(eZC,b1C)
var o2C=_n('text')
...
var oPC=_v()
_(oNC,oPC)
if(_oz(z,83,t7B,a6B,gg)){oPC.wxVkey=1
var o4C=_n('view')
_rz(z,o4C,'class',84,t7B,a6B,gg)
var f5C=_v()
_(o4C,f5C)
if(_oz(z,85,t7B,a6B,gg)){f5C.wxVkey=1
var c6C=_n('view')
var h7C=_n('text')
_(c6C,h7C)
_(f5C,c6C)
...
var o8C=_v()
_(f5C,o8C)
if(_oz(z,86,t7B,a6B,gg)){o8C.wxVkey=1
var c9C=_n('view')
var o0C=_n('text')
_(c9C,o0C)
var lAD=_n('text')
...
var aBD=_v()
_(o8C,aBD)
if(_oz(z,87,t7B,a6B,gg)){aBD.wxVkey=1
var tCD=_n('view')
var eDD=_n('text')
_(tCD,eDD)
var bED=_n('text')
...
var xAC=_v()
_(o0B,xAC)
if(_oz(z,88,t7B,a6B,gg)){xAC.wxVkey=1
var xGD=_n('view')
_rz(z,xGD,'class',89,t7B,a6B,gg)
var oHD=_n('view')
_rz(z,oHD,'class',90,t7B,a6B,gg)
var fID=_oz(z,91,t7B,a6B,gg)
_(oHD,fID)
var cJD=_n('text')
var hKD=_oz(z,92,t7B,a6B,gg)
_(cJD,hKD)
_(oHD,cJD)
_(xGD,oHD)
var oLD=_n('view')
_rz(z,oLD,'class',93,t7B,a6B,gg)
var cMD=_oz(z,94,t7B,a6B,gg)
_(oLD,cMD)
_(xGD,oLD)
_(xAC,xGD)
}
...
var oND=_v()
_(xAC,oND)
if(_oz(z,95,t7B,a6B,gg)){oND.wxVkey=1
var lOD=_n('view')
_rz(z,lOD,'class',96,t7B,a6B,gg)
var aPD=_n('view')
_rz(z,aPD,'class',97,t7B,a6B,gg)
var tQD=_oz(z,98,t7B,a6B,gg)
_(aPD,tQD)
var eRD=_n('text')
var bSD=_oz(z,99,t7B,a6B,gg)
_(eRD,bSD)
_(aPD,eRD)
_(lOD,aPD)
var oTD=_n('view')
_rz(z,oTD,'class',100,t7B,a6B,gg)
var xUD=_oz(z,101,t7B,a6B,gg)
_(oTD,xUD)
_(lOD,oTD)
_(oND,lOD)
}
...
var oVD=_v()
_(oND,oVD)
if(_oz(z,102,t7B,a6B,gg)){oVD.wxVkey=1
var fWD=_n('view')
_rz(z,fWD,'class',103,t7B,a6B,gg)
var cXD=_n('view')
_rz(z,cXD,'class',104,t7B,a6B,gg)
var hYD=_oz(z,105,t7B,a6B,gg)
_(cXD,hYD)
var oZD=_n('text')
var c1D=_oz(z,106,t7B,a6B,gg)
_(oZD,c1D)
_(cXD,oZD)
_(fWD,cXD)
var o2D=_n('view')
_rz(z,o2D,'class',107,t7B,a6B,gg)
var l3D=_oz(z,108,t7B,a6B,gg)
_(o2D,l3D)
_(fWD,o2D)
_(oVD,fWD)
}
...
var a4D=_v()
_(oVD,a4D)
if(_oz(z,109,t7B,a6B,gg)){a4D.wxVkey=1
var t5D=_n('view')
_rz(z,t5D,'class',110,t7B,a6B,gg)
var e6D=_n('view')
_rz(z,e6D,'class',111,t7B,a6B,gg)
var b7D=_oz(z,112,t7B,a6B,gg)
_(e6D,b7D)
var o8D=_n('text')
var x9D=_oz(z,113,t7B,a6B,gg)
_(o8D,x9D)
_(e6D,o8D)
_(t5D,e6D)
var o0D=_n('view')
_rz(z,o0D,'class',114,t7B,a6B,gg)
var fAE=_oz(z,115,t7B,a6B,gg)
_(o0D,fAE)
_(t5D,o0D)
_(a4D,t5D)
}
...
_(o2E,c7E)
_(lUE,o2E)
var l9E=_mz(z,'view',['catchtap',17,'class',1,'data-event-opts',2],[],e,s,gg)
var a0E=_v()
_(l9E,a0E)
if(_oz(z,20,e,s,gg)){a0E.wxVkey=1
var eBF=_n('view')
_rz(z,eBF,'class',21,e,s,gg)
var bCF=_v()
_(eBF,bCF)
if(_oz(z,22,e,s,gg)){bCF.wxVkey=1
var oDF=_n('view')
var xEF=_n('text')
_(oDF,xEF)
_(bCF,oDF)
...
var oJF=_v()
_(oFF,oJF)
if(_oz(z,24,e,s,gg)){oJF.wxVkey=1
var cKF=_n('view')
var oLF=_n('text')
_(cKF,oLF)
var lMF=_n('text')
...
var aVE=_v()
_(lUE,aVE)
if(_oz(z,30,e,s,gg)){aVE.wxVkey=1
var a2F=_n('view')
...
var tGG=_v()
_(f9F,tGG)
if(_oz(z,44,e,s,gg)){tGG.wxVkey=1
var eHG=_n('view')
_rz(z,eHG,'class',45,e,s,gg)
var bIG=_n('view')
_rz(z,bIG,'class',46,e,s,gg)
var oJG=_oz(z,47,e,s,gg)
_(bIG,oJG)
var xKG=_n('text')
...
var hOG=_v()
_(tGG,hOG)
if(_oz(z,51,e,s,gg)){hOG.wxVkey=1
var oPG=_n('view')
...
var oBH=_n('view')
_rz(z,oBH,'class',75,t9G,a8G,gg)
var xCH=_n('view')
_rz(z,xCH,'class',76,t9G,a8G,gg)
var oDH=_n('view')
_rz(z,oDH,'class',77,t9G,a8G,gg)
var fEH=_oz(z,78,t9G,a8G,gg)
_(oDH,fEH)
_(xCH,oDH)
var cFH=_n('view')
_rz(z,cFH,'class',79,t9G,a8G,gg)
var hGH=_oz(z,80,t9G,a8G,gg)
_(cFH,hGH)
_(xCH,cFH)
_(oBH,xCH)
var oHH=_n('view')
_rz(z,oHH,'class',81,t9G,a8G,gg)
_(oBH,oHH)
var cIH=_n('view')
_rz(z,cIH,'class',82,t9G,a8G,gg)
var oJH=_n('view')
_rz(z,oJH,'class',83,t9G,a8G,gg)
var lKH=_oz(z,84,t9G,a8G,gg)
_(oJH,lKH)
_(cIH,oJH)
var aLH=_n('view')
_rz(z,aLH,'class',85,t9G,a8G,gg)
var tMH=_v()
_(aLH,tMH)
var eNH=function(oPH,bOH,xQH,gg){
var fSH=_v()
_(xQH,fSH)
if(_oz(z,90,oPH,bOH,gg)){fSH.wxVkey=1
var cTH=_mz(z,'image',['mode',-1,'bindtap',91,'data-event-opts',1,'src',2],[],oPH,bOH,gg)
_(fSH,cTH)
}
fSH.wxXCkey=1
return xQH
...
tMH.wxXCkey=2
_2z(z,88,eNH,t9G,a8G,gg,tMH,'item1','index1','index1')
_(cIH,aLH)
_(oBH,cIH)
var hUH=_n('view')
_rz(z,hUH,'class',94,t9G,a8G,gg)
_(oBH,hUH)
_(e0G,oBH)
return e0G
}
...
var oVH=_v()
_(o4G,oVH)
if(_oz(z,95,e,s,gg)){oVH.wxVkey=1
var cWH=_n('view')
_rz(z,cWH,'class',96,e,s,gg)
var oXH=_mz(z,'swiper',['class',97,'indicatorDots',1],[],e,s,gg)
var lYH=_v()
_(oXH,lYH)
var aZH=function(e2H,t1H,b3H,gg){
var x5H=_n('swiper-item')
var o6H=_n('view')
_rz(z,o6H,'class',103,e2H,t1H,gg)
var f7H=_mz(z,'image',['mode',-1,'src',104],[],e2H,t1H,gg)
_(o6H,f7H)
_(x5H,o6H)
_(b3H,x5H)
return b3H
...
lYH.wxXCkey=2
_2z(z,101,aZH,e,s,gg,lYH,'item','__i0__','*this')
_(cWH,oXH)
_(oVH,cWH)
}
oVH.wxXCkey=1
...
var z=gz$gwx_5()
var h9H=_n('view')
var o0H=_mz(z,'view',['bindtap',0,'class',1,'data-event-opts',1],[],e,s,gg)
var cAI=_n('image')
_rz(z,cAI,'src',3,e,s,gg)
_(o0H,cAI)
_(h9H,o0H)
var oBI=_n('view')
...
var tEI=_mz(z,'swiper',['bindchange',7,'class',1,'data-event-opts',2,'indicatorDots',3],[],e,s,gg)
var eFI=_v()
_(tEI,eFI)
var bGI=function(xII,oHI,oJI,gg){
var cLI=_n('swiper-item')
var hMI=_n('view')
_rz(z,hMI,'class',15,xII,oHI,gg)
var oNI=_n('image')
_rz(z,oNI,'src',16,xII,oHI,gg)
_(hMI,oNI)
var cOI=_n('view')
_rz(z,cOI,'class',17,xII,oHI,gg)
var lQI=_n('view')
_rz(z,lQI,'class',18,xII,oHI,gg)
var aRI=_n('view')
_rz(z,aRI,'class',19,xII,oHI,gg)
var eTI=_mz(z,'image',['mode',-1,'src',20],[],xII,oHI,gg)
_(aRI,eTI)
var tSI=_v()
_(aRI,tSI)
if(_oz(z,21,xII,oHI,gg)){tSI.wxVkey=1
var bUI=_n('text')
_(tSI,bUI)
}
tSI.wxXCkey=1
_(lQI,aRI)
var oVI=_n('view')
_rz(z,oVI,'class',22,xII,oHI,gg)
var xWI=_oz(z,23,xII,oHI,gg)
_(oVI,xWI)
_(lQI,oVI)
_(cOI,lQI)
var oPI=_v()
_(cOI,oPI)
if(_oz(z,24,xII,oHI,gg)){oPI.wxVkey=1
var oXI=_n('view')
_rz(z,oXI,'class',25,xII,oHI,gg)
var fYI=_n('text')
_(oXI,fYI)
var cZI=_oz(z,26,xII,oHI,gg)
_(oXI,cZI)
_(oPI,oXI)
}
var h1I=_n('view')
_rz(z,h1I,'class',27,xII,oHI,gg)
var o2I=_n('view')
var c3I=_oz(z,28,xII,oHI,gg)
_(o2I,c3I)
_(h1I,o2I)
var o4I=_n('view')
var l5I=_oz(z,29,xII,oHI,gg)
_(o4I,l5I)
_(h1I,o4I)
_(cOI,h1I)
oPI.wxXCkey=1
_(hMI,cOI)
var a6I=_n('view')
_rz(z,a6I,'class',30,xII,oHI,gg)
var t7I=_v()
_(a6I,t7I)
if(_oz(z,31,xII,oHI,gg)){t7I.wxVkey=1
var b9I=_n('view')
_rz(z,b9I,'class',32,xII,oHI,gg)
var o0I=_oz(z,33,xII,oHI,gg)
_(b9I,o0I)
_(t7I,b9I)
}
var e8I=_v()
_(a6I,e8I)
if(_oz(z,34,xII,oHI,gg)){e8I.wxVkey=1
var xAJ=_n('view')
_rz(z,xAJ,'class',35,xII,oHI,gg)
var oBJ=_oz(z,36,xII,oHI,gg)
_(xAJ,oBJ)
_(e8I,xAJ)
}
t7I.wxXCkey=1
...
_(hMI,a6I)
var fCJ=_n('view')
_rz(z,fCJ,'class',37,xII,oHI,gg)
var cDJ=_n('view')
_rz(z,cDJ,'class',38,xII,oHI,gg)
var hEJ=_n('view')
_rz(z,hEJ,'class',39,xII,oHI,gg)
var oFJ=_n('text')
_(hEJ,oFJ)
var cGJ=_oz(z,40,xII,oHI,gg)
_(hEJ,cGJ)
_(cDJ,hEJ)
var oHJ=_mz(z,'view',['bindtap',41,'class',1,'data-event-opts',2],[],xII,oHI,gg)
var lIJ=_oz(z,44,xII,oHI,gg)
_(oHJ,lIJ)
_(cDJ,oHJ)
_(fCJ,cDJ)
var aJJ=_n('view')
_rz(z,aJJ,'class',45,xII,oHI,gg)
var tKJ=_v()
_(aJJ,tKJ)
var eLJ=function(oNJ,bMJ,xOJ,gg){
var fQJ=_n('view')
_rz(z,fQJ,'class',50,oNJ,bMJ,gg)
var cRJ=_n('view')
_rz(z,cRJ,'class',51,oNJ,bMJ,gg)
var hSJ=_mz(z,'image',['mode',-1,'src',52],[],oNJ,bMJ,gg)
_(cRJ,hSJ)
_(fQJ,cRJ)
var oTJ=_n('view')
_rz(z,oTJ,'class',53,oNJ,bMJ,gg)
var cUJ=_oz(z,54,oNJ,bMJ,gg)
_(oTJ,cUJ)
_(fQJ,oTJ)
_(xOJ,fQJ)
return xOJ
...
tKJ.wxXCkey=2
_2z(z,48,eLJ,xII,oHI,gg,tKJ,'item1','index1','index1')
_(fCJ,aJJ)
_(hMI,fCJ)
_(cLI,hMI)
_(oJI,cLI)
...
eFI.wxXCkey=2
_2z(z,13,bGI,e,s,gg,eFI,'item','index','index')
_(aDI,tEI)
_(lCI,aDI)
_(oBI,lCI)
_(h9H,oBI)
...
var tYJ=_mz(z,'image',['mode',-1,'src',2],[],e,s,gg)
_(aXJ,tYJ)
_(lWJ,aXJ)
var eZJ=_n('view')
...
_(oFK,xGK)
_(bEK,oFK)
var oHK=_mz(z,'input',['bindblur',10,'class',1,'data-event-opts',2,'placeholder',3],[],e,s,gg)
_(bEK,oHK)
_(eDK,bEK)
_(tCK,eDK)
var fIK=_mz(z,'view',['bindtap',14,'class',1,'data-event-opts',2],[],e,s,gg)
...
var oNK=_n('image')
_rz(z,oNK,'src',2,e,s,gg)
_(cMK,oNK)
_(oLK,cMK)
var lOK=_n('view')
_rz(z,lOK,'class',3,e,s,gg)
var aPK=_n('rich-text')
_rz(z,aPK,'nodes',4,e,s,gg)
_(lOK,aPK)
_(oLK,lOK)
_(r,oLK)
return r
...
var hYK=_mz(z,'image',['mode',-1,'src',7],[],e,s,gg)
_(cXK,hYK)
_(fWK,cXK)
var oZK=_n('view')
_rz(z,oZK,'class',8,e,s,gg)
var c1K=_mz(z,'image',['mode',-1,'src',9],[],e,s,gg)
_(oZK,c1K)
_(fWK,oZK)
_(eRK,fWK)
var o2K=_n('view')
...
_(o2K,l3K)
_(eRK,o2K)
var a4K=_mz(z,'view',['bindtap',12,'class',1,'data-event-opts',2],[],e,s,gg)
...
var css_id;
var info = info || {};
var _C= [[[2,1],],["@charset \x22UTF-8\x22;\nbody { width: ",[0,750],"; height: 100vh; margin: 0 auto; }\n",],];
